...
There are two `nomisr` vignettes. The [introduction](https://docs.evanodell.com/nomisr/articles/introduction.html) has details on all available functions and basic demonstrations of their use. The [Work and Health Indicators with nomisr](https://docs.evanodell.com/nomisr/articles/introduction-to-work-and-health-nomis-indicators) vignette shows a worked-through demonstration demonstrating the use of key indicators, courtesy of [Nina Robery](https://github.com/ninarobery) from Public Health England.
