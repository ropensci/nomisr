...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/ropensci/nomisr?branch=master&svg=true)](https://ci.appveyor.com/project/ropensci/nomisr)
...
Odell E (2018). _nomisr: Access Nomis UK labour market data on with R_. doi: 10.5281/zenodo.1157908 (URL:
http://doi.org/10.5281/zenodo.1157908), R package version 0.1.0, <URL:
