...
#' returns the codes for a given concept in a `tibble`, given a dataset
...
#' character `*` can be added to the beginning and/or end of each
#' search string. Search strings are not case sensitive.
#' Defaults to `NULL`. Note that the search function is not very powerful
#' for some datasets.
#'
